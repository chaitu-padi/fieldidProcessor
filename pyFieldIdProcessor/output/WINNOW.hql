...
where trim(oi.fieldid) in ('fieldid_0002');
...
and allprod.product='CC'
and allprod.ods='2019_09_30_001'
where trim(oi.fieldid) in ('fieldid_0003');
...
and allprod.product='CC'
and allprod.ods='2019_09_30_001'
where trim(oi.fieldid) in ('fieldid_0007');